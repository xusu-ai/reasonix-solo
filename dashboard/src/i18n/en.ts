export const en = {
  ...
  chat: {
    ...
    railWorkspaces: "📂 workspaces",
    railWorkspaceLoading: "loading…",
    railWorkspaceEmpty: "(empty)",
    railWorkspaceActive: "← active",
    railWorkspaceTooltip: "Double-click to switch workspace: {path}",
    statusModel: "model",
    statusCtx: "ctx",
    statusCache: "cache",
    statusTurn: "turn",
    ...
    apiKeyProfiles: "API Key",
    apiKeySwitchOk: "Switched to {label} (next turn)",
  },
  overview: {
  ...
  sessions: {
    ...
    clearAllConfirm: "Delete ALL history sessions? This cannot be undone.",
    clearAllDone: "cleared {count} session(s)",
  ...
  plans: {
    ...
    step: "step {n}",
    clearAllBtn: "Clear All",
    clearAllConfirm: "Delete all archived plans? This cannot be undone.",
    clearAllDone: "Deleted {count} plans",
  },
  semantic: {
