export const zhCN = {
  ...
  chat: {
    ...
    railProgress: "进度",
    railWorkspaces: "📂 工作区",
    railWorkspaceLoading: "加载中…",
    railWorkspaceEmpty: "（空）",
    railWorkspaceActive: "← 当前",
    railWorkspaceTooltip: "双击切换工作区：{path}",
    statusModel: "模型",
    statusCtx: "上下文",
    statusCache: "缓存",
    statusTurn: "轮次",
    ...
    apiKeySwitchOk: "已切换至 {label}（下一轮生效）",
  },
  overview: {
    loading: "加载概览…",
    failed: "概览失败：{error}",
  ...
  sessions: {
    ...
    clearAllBtn: "清空全部",
    clearAllConfirm: "确定删除全部历史会话？此操作无法撤销。",
    clearAllDone: "已清除 {count} 个会话",
  ...
  plans: {
    ...
    step: "步骤 {n}",
    clearAllBtn: "清空全部",
    clearAllConfirm: "确定删除全部已归档计划？此操作无法撤销。",
    clearAllDone: "已删除 {count} 个计划",
  },
  semantic: {
